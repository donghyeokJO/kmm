...
<header class="pc_header">
    ...
    <section id="login">
        <div class="login_left">
            <div class="text_align_center font_weight_n" style="font-size: 24px; color: #747474;">비밀번호 찾기</div>
            <form id="signup_form_01" method="POST" action="member/signin.php" style="margin: 0 auto;">
                <div class="row">
                    ...
                    <div class="col-12 margin_top_s">
                        <input type="text" id="u_id" placeholder="가입시 사용한 아이디를 입력해주세요." style=" height: 50px;" />
                    </div>
                    ...
                    <div class="col-12 margin_top_l font_weight_b" id="id_row" style="display:none">임시비밀번호</div>
                    <div class="col-12 margin_top_s" id="user_id" style="display :none">
                        <input type="text" id="u_pw" readonly placeholder="" style="height: 50px;" />
                    </div>
                    <div class="col-12" style="margin-top: 40px;padding: 0">
                        <div class="button" style="margin: 0 auto; background-color: #2b2b2b; color:#fff" onclick="findpw()">임시 비밀번호 발급 받기
                        </div>

                    </div>
                    <div class="line col-12 margin_v_l"></div>

                    <div class="col-12 text_align_center font_size_m font_weight_b">계정이 없으신가요? <span class="color_b"><a href="signup">계정 만들기</a></span></div>
                </div>
            </form>
        </div>
