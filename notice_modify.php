...
<header class="pc_header">
    ...
    <section id="pre">
        ...
        <div class="board_area">
            <form id ="board_form" action="/form/notice_modify" method = "POST">
                <div class="board_title_area">
                    <div class="insert_board_title">
                        제목
                    </div>
                    <input type="text" name = "title" class="input_board_title" value = "<?php echo $notice['title']?>">
                </div>
                <!-- <div class="board_name_area"> -->
                    ...
                    <!-- <input type="radio" name="name_radio" id="name_radio2">
                    <label for="name_radio2">고정필명 :</label>
                ...
                <div class="board_content_area">
                    ...
                    <textarea name="notice_content" id="notice_content" cols="30" rows="10"
                        class="input_board_content"><?php echo $notice['content']?></textarea>
                </div>
                ...
                <div class="button_area">
                    <div class="cancel_btn" onclick="history.go(-1)">
                        취소
                    </div>
