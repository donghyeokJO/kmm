...
<header class="pc_header">
    ...
    <section id="pre">
        ...
        <div class="pre_item_area" id ="pre_item_area">
            <!-- <div class="pre_item">
                <a href="pre_detail">
                    <div class="pre_item_term">
                        2020-01-12 ~ 2020-01-12
                    </div>
                    <div class="pre_item_title">
                        2020 대미개 라이브아카데미 in 대구
                    </div>
                    <div class="pre_item_tel">
                        사무국 02-3443-1232
                    </div>
                </a>
            </div>
