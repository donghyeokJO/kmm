    ...
    <section id="pre">
        ...
        <div class="notice_area">
            ...
            <?php
              if ($u_type == '관리자') {
                  echo'
                    <div class="insert_board_btn" onclick="location.href=\'insert_notice\'">
                        글쓰기
                    </div>';
              } else {
...
function sendLink() {
  ...
  Kakao.Link.sendScrap({
    requestUrl: 'http://kmm.or.kr/notice?page='+page
  });
}
</script>
</html>